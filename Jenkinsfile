    ...
    try {
      stage('Checkout SCM') {
        checkout([
          ...
          extensions: [],
          submoduleCfg: [],
          userRemoteConfigs: [[credentialsId: 'bc074014-bab1-4fb0-b5a4-4cfa9ded5e66',url: 'git@gitlab.citeck.ru:citeck-projects/ecos-registry.git']]
        ])
      }
      ...
      stage('Push docker image') {
        docker.withRegistry('http://127.0.0.1:8082', '7d800357-2193-4474-b768-5c27b97a1030') {
          def microserviceImage = "ecos-registry"+":"+"${project_version}"
